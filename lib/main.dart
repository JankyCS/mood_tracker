...
class _MyAppState extends State<MyApp> {
  ...
  Future<void> _repeatNotification() async {
    ...
    var platformChannelSpecifics = NotificationDetails(
        androidPlatformChannelSpecifics, iOSPlatformChannelSpecifics);
    await flutterLocalNotificationsPlugin.periodicallyShow(0, 'repeating title1',
        'repeating body1', RepeatInterval.EveryMinute, platformChannelSpecifics);
  }
  ...
  Future<void> _repeatNotification3() async {
    ...
    var platformChannelSpecifics = NotificationDetails(
        androidPlatformChannelSpecifics, iOSPlatformChannelSpecifics);
    await flutterLocalNotificationsPlugin.periodicallyShow(2, 'repeating title3',
        'repeating body3', RepeatInterval.EveryMinute, platformChannelSpecifics);
  }
  ...
  Future<void> _repeatNotification4() async {
    ...
    var platformChannelSpecifics = NotificationDetails(
        androidPlatformChannelSpecifics, iOSPlatformChannelSpecifics);
    await flutterLocalNotificationsPlugin.periodicallyShow(3, 'repeating title4',
        'repeating body4', RepeatInterval.EveryMinute, platformChannelSpecifics);
  }

  Future<void> _showDailyAtTime() async {
    var time = Time(3, 39, 30);
    var androidPlatformChannelSpecifics = AndroidNotificationDetails(
  ...
  Future<void> _wednesday() async {
    var time = Time(15, 47, 0);
    var androidPlatformChannelSpecifics = AndroidNotificationDetails(
        'show weekly channel id',
        'show weekly channel name',
        'show weekly description');
